  ...
  const features = [
    {
      ...
      description: 'Well-researched curriculum designed by experts',
      icon: (
    ...
    {
      title: 'Live & Recorded',
      description: 'Access classes anytime with recordings',
      icon: (
        <svg className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Regular tests with detailed analysis',
      icon: (
        <svg className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            We combine technology with traditional teaching methods for maximum effectiveness
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="inline-flex p-3 rounded-xl bg-blue-600 mb-6">
                {feature.icon}
              </div>
